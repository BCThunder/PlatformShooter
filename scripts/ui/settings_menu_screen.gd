...
@onready var window_option_button = $MarginContainer/PanelContainer/MarginContainer/VBoxContainer/WindowOptionButton
...
func initialize_controls():
	...
	window_option_button.selected = settings_data.window_mode_index
