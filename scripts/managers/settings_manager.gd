...
var save_filename = "settings_data.tres"
...
func load_settings():
	...
	if ResourceLoader.exists(save_settings_path + save_filename):
		settings_data = ResourceLoader.load(save_settings_path + save_filename)
	elif !ResourceLoader.exists(save_settings_path + save_filename):
...
func save_settings():
	ResourceSaver.save(settings_data, save_settings_path + save_filename)
